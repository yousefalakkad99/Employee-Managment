									...
									<div class="card-sigin">
										...
										<div class="card-sigin">
											<div class="main-signup-header">
												...
												<h3 class="font-weight-semibold mb-4">تعديل بيانات الحساب</h3>
                                                <form action="{{ route('user.update',$user->id) }}" method="post" enctype='multipart/form-data' >
                                                    @csrf
													<div class="form-group">
														<label><h4  class="font-weight-semibold mb-1">اسم المستخدم</h4></label>
                                                         <input class="form-control" placeholder="ادخل اسم المستخدم" type="text" name="username" value="{{$user->username}}">
                                                         @error('username')
                                                    ...
                                                    <div class="form-group">
														<label><h4  class="font-weight-semibold mb-1">البريد الالكتروني</h4></label>
                                                         <input class="form-control" placeholder="ادخل البريد الالكتروني" type="email" name="email" value="{{$user->email}}">
                                                         @error('email')
                                                         <div class="alert alert-danger" role="alert">
                                                         {{$message}}
                                                         </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        {!! Form::select('roles_name[]', $roles_name,$userRole, array('class' => 'form-control','multiple')) !!}
                                                        @error('roles_name')
                                                        <div class="alert alert-danger" role="alert">
                                                            {{$message}}
                                                        </div>
                                                    ...
                                                    <button class="btn btn-main-primary btn-block">تعديل حساب</button>
